...
import BrowseLawyersModal from "../components/will/BrowseLawyersModal";
...
export default function Will() {
  ...
  const loadSigs = useCallback(async () => {
    try {
      ...
      logger.debug("will/signatures load failed", e);
    }
  }, []);
  ...
  // Ask-a-lawyer marketplace (modal extracted to components/will/BrowseLawyersModal.jsx)
    ...
    <div className="max-w-5xl mx-auto px-8 py-10" data-testid="will-page">
      ...
      <section className="card-flat p-6 mb-6" data-testid="will-signatures-section">
        ...
        <div className="mb-5 pb-5 border-b hairline">
          ...
          <div className="flex flex-wrap gap-2 mt-3">
            <button onClick={() => setBrowseOpen(true)} className="btn-primary px-4 py-2 text-xs inline-flex items-center gap-2" data-testid="will-browse-lawyers">
      ...
      {browseOpen && (
        <BrowseLawyersModal
          ...
          onPaid={loadSigs}
          onSaveDraft={save}
          onSwitchManual={() => { setBrowseOpen(false); setLawyerOpen(true); }}
        />
      )}
    </div>
  );
