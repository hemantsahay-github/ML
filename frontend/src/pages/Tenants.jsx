...
function AadhaarModal({ tenant, onClose, onVerified }) {
      ...
      <div className="relative card-flat w-full max-w-md mx-6 p-8">
        ...
        {step === "initiate" ? (
          <div className="space-y-3">
            <F label="Aadhaar last 4 digits *"><input className="input-dark w-full px-3 py-2 tracking-widest" maxLength={4} value={form.aadhaar_last_4} onChange={(e) => setForm({ ...form, aadhaar_last_4: e.target.value.replace(/\D/g, "") })} data-testid="aadhaar-last4" /></F>
            <F label="Aadhaar-linked phone *"><input className="input-dark w-full px-3 py-2" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} data-testid="aadhaar-phone" /></F>
            <F label="Name (as on Aadhaar) *"><input className="input-dark w-full px-3 py-2" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} /></F>
          ...
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">OTP sent to phone ending {form.phone.slice(-4)}. In stub mode, any 6 digits work.</p>
            <F label="6-digit OTP *"><input className="input-dark w-full px-3 py-2 text-xl tracking-[0.5em] text-center" maxLength={6} value={form.otp} onChange={(e) => setForm({ ...form, otp: e.target.value.replace(/\D/g, "") })} data-testid="aadhaar-otp" /></F>
            <div className="flex gap-3 pt-3">
